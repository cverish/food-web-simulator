      ...
      <Container maxWidth="lg">
        <Box sx={{ display: "flex", alignItems: "center" }}>
          <Box sx={{ flexGrow: 1 }}>
            ...
            >
              <T variant="h3">Food Web Simulator</T>
            </Link>
          </Box>
          <Box>
            <Link href="/simulator">
              <Tooltip title="Explore Food Webs">
                <IconButton>
    ...
    <Box component="footer" sx={styles.footer}>
      <Container maxWidth="lg">
        <Box sx={{ display: "flex", alignItems: "center" }}>
          ...
          <Box sx={{ mt: "3px", ml: 1 }}>
            <Tooltip title="View source on GitHub!" placement="top-end" arrow>
              <a
                href="https://github.com/cverish/food-web-simulator"
                style={{ color: "inherit" }}
              >
                <svg
                  width="15"
